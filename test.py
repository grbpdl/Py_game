...
class gamestate:
    ...
    def game1(self):
            def input_text():
                ...
                while not done:
                    ...
                    pygame.draw.rect(App.screen, color, input_box, 2)
    ...
    def game3(self):
            ...
            self.textRect = self.text.get_rect()
            self.textRect.center = (680,430)
            self.textone = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, BLACK,white)
            self.textoneRect = self.textone.get_rect()
            self.textoneRect.center = (155,435)
            self.texttwo = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,0),(255,255,255))
            self.texttwoRect = self.texttwo.get_rect()
            self.texttwoRect.center = (260,435)
            self.textthree = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,0),(255,255,255))
            self.textthreeRect = self.textthree.get_rect()
            self.textthreeRect.center = (365,435)
            self.textfour = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,0),(255,255,255))
            self.textfourRect = self.textfour.get_rect()
            self.textfourRect.center = (465,435)
            self.textfive = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,0),(255,255,255))
            self.textfiveRect = self.textfive.get_rect()
            self.textfiveRect.center = (565,435)
            self.textsix = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,0),(255,255,255))
            self.textsixRect = self.textsix.get_rect()
            self.textsixRect.center = (665,435)
    ...
    def game4(self):
            ...
            self.textRect = self.text.get_rect()
            self.textRect.center = (680,430)
            self.textone = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (250,100,255),(10,255,0))
            self.textoneRect = self.textone.get_rect()
            self.textoneRect.center = (155,435)
            self.texttwo = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,255),(255,165,0))
            self.texttwoRect = self.texttwo.get_rect()
            self.texttwoRect.center = (255,435)
            self.textthree = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,255),(255,165,0))
            self.textthreeRect = self.textthree.get_rect()
            self.textthreeRect.center = (355,435)
            self.textfour = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,255),(255,165,0))
            self.textfourRect = self.textfour.get_rect()
            self.textfourRect.center = (455,435)
            self.textfive = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,255),(255,165,0))
            self.textfiveRect = self.textfive.get_rect()
            self.textfiveRect.center = (555,435)
            self.textsix = pygame.font.Font('freesansbold.ttf', 20).render('Select', True, (0,0,255),(255,165,0))
            self.textsixRect = self.textsix.get_rect()
            ...
            pygame.display.update()
    def result(self):
            self.text = pygame.font.Font('freesansbold.ttf', 25).render('Restart', True, (0,0,255),(255,180,0))
            self.textRect = self.text.get_rect()
